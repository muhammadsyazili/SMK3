...
<!-- ========= formulir PERMIT ================================= -->
<?= form_open_multipart('pengajuan/ubah_pengajuan'); ?>
<h2 class="text-center text-uppercase">ubah pengajuan</h2>
<hr>
	...
	<table>
	    ...
	    <?php foreach ($d_a_pengawas as $d): ?>
	      <tr>
	        ...
	        <td><input class="form-control" type="text" name="pengawas[]" value="<?= $d->nama_pengawas; ?>" style="width: 300px;" required/></td>

	        <td class="text-uppercase"><label class="text-uppercase">nama kontraktor :</label></td>
	        <td><input class="form-control" type="text" name="kontraktor[]" value="<?= $d->kontraktor; ?>" style="width: 300px;" required/></td>
	      </tr>
	    <?php endforeach; ?>
	    </tbody>
	</table>
	...
	<table>
	    ...
	    <?php foreach ($d_a_petugas as $d): ?>
	      <tr>
	        ...
	        <td><input class="form-control" type="text" name="pekerja[]" value="<?= $d->nama_pekerja; ?>" style="width: 500px;" required/></td>
	      </tr>
	    <?php endforeach; ?>
	    </tbody>
	</table>
		...
		<table>
		    ...
		    <?php foreach ($d_a_k2 as $d): ?>
		      <tr>
		        ...
		        <td><input class="form-control" type="text" name="k2[]" value="<?= $d->nama_peralatan; ?>" style="width: 900px;"/></td>
		      </tr>
		    <?php endforeach; ?>
		    </tbody>
		</table>
...
<div class="row action">
	<div class="col-md-6">
		<input type="submit" value="simpan" class="btn btn-primary btn-block text-uppercase btn-sub" name="ubah"></input>
		<input type="hidden" name="tgl_pengajuan" value="<?= $dt->tgl_pengajuan; ?>">
		<input type="hidden" name="id_pengajuan" value="<?= base64_encode($dt->id_pengajuan);?>">
	</div>
	<div class="col-md-6">
