...
<!-- ========= formulir PERMIT ================================= -->
<?= form_open_multipart('pekerjaan/tambah_pekerjaan'); ?>
<h2 class="text-center text-uppercase">tambah pekerjaan</h2>
<hr>
...
<div class="well">
	...
	<div class="row">
		...
		<div class="col-md-3 text-capitalize">
			<div class="checkbox">
			<label><input type="checkbox" name="aplikasi[]" value="<?= $d->id_aplikasi; ?>" onclick="cek_checkbox();"><?= $d->n_aplikasi; ?></label>
			</div>
		</div>
		<?php endforeach; ?>
	</div>
	...
	<table>
	    <tbody>
	      <tr>
	        ...
	        <td><input class="form-control" type="text" name="pengawas[]" style="width: 300px;" /></td>

	        <td class="text-uppercase"><label class="text-uppercase">nama kontraktor :</label></td>
	        <td><input class="form-control" type="text" name="kontraktor[]" style="width: 300px;" /></td>
	      </tr>
	    </tbody>
	</table>
	  <p>
	...
	<table>
	    <tbody>
	      <tr>
	        ...
	        <td><input class="form-control" type="text" name="pekerja[]" style="width: 500px;" /></td>
	      </tr>
	    </tbody>
	</table>
	  <p>
		...
		<table>
		    <tbody>
		      <tr>
		        ...
		        <td><input class="form-control" type="text" name="dPekerjaan[]" required style="width: 1000px;" /></td>
		      </tr>
		    </tbody>
		</table>
		  <p>
		...
		<table>
		    <tbody>
		      <tr>
		        ...
		        <td><input class="form-control" type="text" name="k2[]" required style="width: 1000px;"/></td>
		      </tr>
		    </tbody>
		</table>
		  <p>
...
<div class="row action">
	<div class="col-md-6">
		<input type="submit" value="tambah pekerjaan" class="btn btn-primary btn-block text-uppercase btn-sub" name="tambah"></input>
		<input type="hidden" name="status_pekerjaan" value="1">
	</div>
	<div class="col-md-6">
