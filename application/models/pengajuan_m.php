...
*/
  ...
  {
    private $table = ['pengajuan', 'pengawas', 'pekerja', 'peralatan', 'vendor', 'rayon', 'penyulang', 'aplikasi', 'jenis_peralatan', 'bahaya_pekerjaan', 'tindakan_pencegahan', 'apd', 'langkah_pengerjaan', 'peralatan_kerja_k2', 'detail_pekerjaan', 'd_aplikasi', 'd_jPeralatan', 'd_bahaya', 'd_tPencegahan', 'd_apd', 'akun'];
...
//==================================================== set function
    public function set_pengajuan($data)
    {
...
//==================================================== get function
    ...
    public function get_pengajuan($where, $order)
    {
      $this->db->select('vendor.nama_vendor, pengajuan.*, rayon.nama_rayon, penyulang.nama_penyulang');
      $this->db->from($this->table[0]);
      $this->db->join($this->table[4], 'pengajuan.id_vendor = vendor.id_vendor');
      $this->db->join($this->table[5], 'pengajuan.id_rayon = rayon.id_rayon');
      $this->db->join($this->table[6], 'pengajuan.id_penyulang = penyulang.id_penyulang');
    ...
    public function get_pengajuan_by_idPengajuan($where)
    {
      $this->db->select('vendor.nama_vendor, pengajuan.*, rayon.id_rayon, penyulang.id_penyulang');
      $this->db->from($this->table[0]);
      $this->db->join($this->table[4], 'pengajuan.id_vendor = vendor.id_vendor');
      $this->db->join($this->table[5], 'pengajuan.id_rayon = rayon.id_rayon');
      $this->db->join($this->table[6], 'pengajuan.id_penyulang = penyulang.id_penyulang');
    ...
    public function get_diagram_by_idPengajuan($where)
    {
      return $this->master_m->read_by_where_return_row($this->table[0], $where)->single_line;
    }

    public function get_SingleLine_by_idAkun($where)
    {
      $this->db->select('pengajuan.single_line');
      $this->db->from($this->table[0]);
      $this->db->join($this->table[4], 'pengajuan.id_vendor = vendor.id_vendor');
      $this->db->join($this->table[20], 'akun.id_akun = vendor.id_akun');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result();
    }

    public function get_aplikasi_by_idPengajuan($where)
    {
      $this->db->select('aplikasi.id_aplikasi');
      $this->db->from($this->table[7]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = aplikasi.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result_array();
    }

    public function get_jenisPeralatan_by_idPengajuan($where)
    {
      $this->db->select('jenis_peralatan.id_jPeralatan');
      $this->db->from($this->table[8]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = jenis_peralatan.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result_array();
    }

    public function get_bahayaPekerjaaan_by_idPengajuan($where)
    {
      $this->db->select('bahaya_pekerjaan.id_bahaya');
      $this->db->from($this->table[9]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = bahaya_pekerjaan.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result_array();
    }

    public function get_tindakanPencegahan_by_idPengajuan($where)
    {
      $this->db->select('tindakan_pencegahan.id_tPencegahan');
      $this->db->from($this->table[10]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = tindakan_pencegahan.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result_array();
    }

    public function get_apd_by_idPengajuan($where)
    {
      $this->db->select('apd.id_apd');
      $this->db->from($this->table[11]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = apd.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result_array();
    }

    public function get_pengawas_by_idPengajuan($where)
    {
      $this->db->select('pengawas.*');
      $this->db->from($this->table[1]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = pengawas.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result();
    }

    public function get_pekerja_by_idPengajuan($where)
    {
      $this->db->select('pekerja.*');
      $this->db->from($this->table[2]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = pekerja.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result();
    }

    public function get_peralatan_by_idPengajuan($where)
    {
      $this->db->select('peralatan.*');
      $this->db->from($this->table[3]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = peralatan.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result();
    }

    public function get_detailPekerjaan_by_idPengajuan($where)
    {
      $this->db->select('detail_pekerjaan.*');
      $this->db->from($this->table[14]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = detail_pekerjaan.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result();
    }

    public function get_k2_by_idPengajuan($where)
    {
      $this->db->select('peralatan_kerja_k2.*');
      $this->db->from($this->table[13]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = peralatan_kerja_k2.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result();
    }

    public function get_langkahPengerjaan_by_idPengajuan($where)
    {
      $this->db->select('langkah_pengerjaan.*');
      $this->db->from($this->table[12]);
      $this->db->join($this->table[0], 'pengajuan.id_pengajuan = langkah_pengerjaan.id_pengajuan');
      $this->db->where($where);
      $q = $this->db->get();
      return $q->result();
    }
//==================================================== cek function
    public function cek_pengajuan($where)
    {
      return $this->master_m->count_by_where($this->table[0], $where);
    }

    public function cekAll_pengajuan()
    {
...
//==================================================== delete function
    ...
    public function delete_a_bahaya($where)
    {
